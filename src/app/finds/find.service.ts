...
findUser(username){
    ...
    let promise = new Promise((resolve, reject) => {
      this.http.get<ApiResponse>("https://api.github.com/users/"+ this.username+"?access_token=d67a16a292d55ec18ec7c36b4956341eaeaba132").toPromise().then(response => {
        ...
        this.user.view = response.repos_url;
